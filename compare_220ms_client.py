...
# %% load qlog files
max_ms = 15000
client_side_proxy_handover_ms = 660
conn: Connection = read_qlog('./data/220ms/qlog/client.qlog.gz', max_ms=max_ms)
conn_1p: Connection = read_qlog('./data/220ms_client_side_proxy/qlog/client_side_proxy_server_facing.qlog.gz',
                                max_ms=max_ms, shift_ms=client_side_proxy_handover_ms)
conn_2p: Connection = read_qlog('./data/220ms_two_proxies/qlog/client_side_proxy_server_facing.qlog.gz',
                                max_ms=max_ms, shift_ms=client_side_proxy_handover_ms)
conn_2p_simple: Connection = read_qlog('./data/220ms_two_proxies_simple/qlog/client_side_proxy_server_facing.qlog.gz',
                                max_ms=max_ms, shift_ms=client_side_proxy_handover_ms)
