...
conn_2p: Connection = read_qlog('./data/1000ms_two_proxies/server_side_proxy_client_facing.qlog', shift_ms=2000,
                                max_ms=max_ms)
...
fig.savefig(f'./plots/compare_1000ms_full.pdf', bbox_inches='tight', dpi=300)
plt.plot()
