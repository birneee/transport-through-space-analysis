...
# %% load qlog files
max_ms = 40000
client_side_proxy_handover_ms = 3000
conn: Connection = read_qlog('./data/1000ms/qlog/client.qlog.gz', max_ms=max_ms)
conn_1p: Connection = read_qlog('./data/1000ms_client_side_proxy/qlog/client_side_proxy_server_facing.qlog.gz',
                                max_ms=max_ms, shift_ms=client_side_proxy_handover_ms)
conn_2p: Connection = read_qlog('./data/1000ms_two_proxies/qlog/client_side_proxy_server_facing.qlog.gz',
                                max_ms=max_ms, shift_ms=client_side_proxy_handover_ms)
conn_2p_simple: Connection = read_qlog('./data/1000ms_two_proxies_simple/qlog/client_side_proxy_server_facing.qlog.gz',
                                max_ms=max_ms, shift_ms=client_side_proxy_handover_ms)
...
plot_stream_data_received(ax, conn_2p_simple, 0, label='Proxies on both sides', color='red')
plot_stream_data_received(ax, conn_2p, 0, label='Proxies on both sides (fixed congestion window)', color='#ffa600')
...
plot_local_stream_flow_limit(ax, conn_2p_simple, 0, label=None, color='red', linestyle='dashed')
...
plot_time_to_first_byte(ax, conn_2p_simple, 0, label=None, color='red')
