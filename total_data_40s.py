...
], 40, x=xlabels, label='No PEP', transform=trans + offset(-28), color="#253c4b")
...
], 40, x=xlabels, label='Client-side PEP', transform=trans + offset(-14), color="#00885c")
...
], 40, x=xlabels, label='Distributed PEP', color="#ffa600")
...
], 40, x=xlabels[:-1], label='Distributed PEP (XSE)', transform=trans + offset(14), color="#bc32cf")
...
], 40, x=xlabels, color='tab:orange', label='Distributed PEP (static CC)', transform=trans + offset(28))
