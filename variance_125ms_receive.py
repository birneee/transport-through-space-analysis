...
# %% load qlog files
max_ms = 40000
conn1: Connection = read_qlog('./data/125ms/client.qlog.gz', max_ms=max_ms)
conn2: Connection = read_qlog('./data/125ms/2/client.qlog.gz', max_ms=max_ms)
conn3: Connection = read_qlog('./data/125ms/3/client.qlog.gz', max_ms=max_ms)
conn4: Connection = read_qlog('./data/125ms/4/client.qlog.gz', max_ms=max_ms)
